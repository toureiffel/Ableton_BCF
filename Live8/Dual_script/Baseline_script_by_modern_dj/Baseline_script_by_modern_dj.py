...
class Baseline_script_by_modern_dj(ControlSurface):
    ...
    # Getting issues on Channel switching via Livid Base.  The log is clean - but is the issue fixed? please email em marc@modern.dj if you know or can help.
    ...
    def __init__(self, c_instance):
        ...
        self.log_message(time.strftime("%d.%m.%Y %H:%M:%S", time.localtime()) + "..::|| Modern.DJ LIVE8 ch1 baseline MRS opened::..")
